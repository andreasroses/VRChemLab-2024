...
namespace Coherence.Generated
{
    ...
    public struct _360648f3c22c9fb41a4ac920b8269f70_976679110228619647 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.positionMask;
            positionSimulationFrame = frame;
            FieldsMask |= _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _360648f3c22c9fb41a4ac920b8269f70_976679110228619647 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _360648f3c22c9fb41a4ac920b8269f70_976679110228619647();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
                min = this.positionSimulationFrame;
            }
            if ((FieldsMask & _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_360648f3c22c9fb41a4ac920b8269f70_976679110228619647)data;
        ...
        public static uint Serialize(_360648f3c22c9fb41a4ac920b8269f70_976679110228619647 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _360648f3c22c9fb41a4ac920b8269f70_976679110228619647 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _360648f3c22c9fb41a4ac920b8269f70_976679110228619647();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.positionMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _360648f3c22c9fb41a4ac920b8269f70_976679110228619647.rotationMask;
            }
        ...
        {
            return $"_360648f3c22c9fb41a4ac920b8269f70_976679110228619647(" +
